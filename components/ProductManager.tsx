    ...
    <div className="space-y-6 animate-fadeIn pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium">Gestiona tus servicios y productos con códigos de barras</p>
        </div>
        <button 
        ...
        {filteredProducts.map(product => (
          <div key={product.id} className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-100 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/5 transition-all group relative">
            ...
            <div className="flex justify-between items-baseline mb-1">
              ...
              {product.barcode && (
                <span className="text-[9px] font-bold text-slate-400">🏷️ {product.barcode}</span>
              )}
            </div>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-[120] flex items-end sm:items-center justify-center p-0 sm:p-4">
          <div className="bg-white rounded-t-[40px] sm:rounded-[40px] shadow-2xl w-full max-w-lg overflow-hidden animate-slideUp">
            <div className="bg-slate-900 p-8 text-white relative">
              ...
              <p className="text-slate-400 font-medium text-sm">Información detallada del producto</p>
            ...
            <form onSubmit={handleSave} className="p-8 space-y-6">
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Código de Barras (EAN / UPC)</label>
                  <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="w-14 bg-slate-100 text-slate-700 rounded-2xl flex items-center justify-center text-xl hover:bg-slate-200 transition-colors"
                    >
                      📷
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-4 bg-gray-50 border border-gray-100 rounded-2xl font-black text-xl text-blue-600"
                  />
                </div>
              </div>
